...
namespace BackEnd.Controllers
{
    ...
    public class LibraryController : ControllerBase
    {
        ...
        public IActionResult UpdateProfile(int id, [FromBody] User updatedUser)
        {
            ...
            var existingUser = _library.GetUserById(id);
            ...
            existingUser.Password = updatedUser.Password; // Or use hashed password logic here if needed.

            var updateResult = _library.UpdateUserProfile(existingUser);
            if (updateResult)
            {
